...
public abstract class BetterActivity extends Activity
{
	...
	protected void onSaveInstanceState(Bundle outState)
	{
		...
		outState.putString("test",
				"testing this freaky stuff from google");
	}
	...
	public Object onRetainNonConfigurationInstance()
	{
		...
		if (result == null)
			return "Placeholder value for onRetainNonConfigurationInstance() so that we can deduce an auto-rotate happened (Android design FAIL)";
		else
			return result;
	}
